...
class SymptonsSignsSpider(scrapy.Spider):
    ...
    file_path = '/home/amit-kumar/GDrive/Repositories/GitHub/deep-learning-python/data/diseases_conditions/'
    start_urls = ['https://www.medicinenet.com/diseases_and_conditions/alpha_a.htm']

    def parse_article_page(self, response):
        content = '.'.join(response.css('.apPage>.wrapper>p').extract())
